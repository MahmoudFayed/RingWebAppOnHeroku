...
#include "cpp/include/codeeditor.h"
...
QT_MOC_LITERAL(5, 73, 16), // "insertCompletion"
QT_MOC_LITERAL(6, 90, 10) // "completion"
...
QT_INIT_METAOBJECT const QMetaObject CodeEditor::staticMetaObject = { {
    &GPlainTextEdit::staticMetaObject,
...
void *CodeEditor::qt_metacast(const char *_clname)
{
    ...
    return GPlainTextEdit::qt_metacast(_clname);
}

int CodeEditor::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = GPlainTextEdit::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 3)
