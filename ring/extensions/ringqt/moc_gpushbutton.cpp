...
#include "cpp/include/gpushbutton.h"
...
QT_INIT_METAOBJECT const QMetaObject GPushButton::staticMetaObject = { {
    &QPushButton::staticMetaObject,
    qt_meta_stringdata_GPushButton.data,
