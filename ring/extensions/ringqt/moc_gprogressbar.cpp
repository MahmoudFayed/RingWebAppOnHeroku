...
#include "cpp/include/gprogressbar.h"
...
QT_MOC_LITERAL(1, 13, 16), // "valueChangedSlot"
QT_MOC_LITERAL(2, 30, 0) // ""

    },
    "GProgressBar\0valueChangedSlot\0"
};
...
void GProgressBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<GProgressBar *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject GProgressBar::staticMetaObject = { {
    &QProgressBar::staticMetaObject,
    qt_meta_stringdata_GProgressBar.data,
    qt_meta_data_GProgressBar,
    qt_static_metacall,
    nullptr,
    nullptr
} };
