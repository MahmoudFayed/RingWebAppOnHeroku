...
#include "cpp/include/gradiobutton.h"
...
QT_MOC_LITERAL(1, 13, 11), // "clickedSlot"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 11), // "pressedSlot"
QT_MOC_LITERAL(4, 38, 12), // "releasedSlot"
QT_MOC_LITERAL(5, 51, 11) // "toggledSlot"

    },
    "GRadioButton\0clickedSlot\0\0pressedSlot\0"
    "releasedSlot\0toggledSlot"
};
...
void GRadioButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<GRadioButton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clickedSlot(); break;
        case 1: _t->pressedSlot(); break;
        case 2: _t->releasedSlot(); break;
        case 3: _t->toggledSlot(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject GRadioButton::staticMetaObject = { {
    &QRadioButton::staticMetaObject,
    qt_meta_stringdata_GRadioButton.data,
    qt_meta_data_GRadioButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
